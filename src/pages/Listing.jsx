...
export default function Listing() {
    ...
    return (
        <main>
            ...
            <div 
                className="fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer bottom-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center"
                onClick={() => {
            ...
            <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto m-4 p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
                <div className="w-full">
                    ...
                    <ul className="flex items-center space-x-2 sm:space-x-10 text-sm font-semibold mb-6">
                        ...
                        <li className="flex items-center whitespace-nowrap">
                            ...
                            {listing.parking ? "Parking spot" : "No parkind"}
                        </li>
                        <li className="flex items-center whitespace-nowrap">
                ...
                <div className="w-full h-[200px] md:h-[400px] mt-6 z-10 overflow-x-hidden md:mt-0 md:ml-2">
